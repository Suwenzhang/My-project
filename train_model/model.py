...
class ResNetWithProjection(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, projection_dim=128):
        ...
        self.projection_head = nn.Sequential(
            ...
            nn.BatchNorm1d(projection_dim),  # 加入BN来增强稳定性
        )
    ...
    def forward(self, x):
        ...
        # 自适应平均池化，确保输出维度为 (batch_size, 512, 1, 1)
...
def nt_xent_loss(projections, temperature=0.5):
    ...
    # Mask for positive pairs (diagonal elements should be positive)
