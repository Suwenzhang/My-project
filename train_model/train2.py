        ...
        for epoch in range(epochs):
            ...
            for i, (images, labels) in enumerate(progress_bar):
                ...
                with autocast():  # 使用混合精度计算
                    ...
                    # 动态平衡对比学习和分类任务损失
                    alpha = 0.5 * (1 + np.cos(np.pi * epoch / epochs))  # 余弦衰减
                    total_loss_step = (1 - alpha) * contrastive_loss + alpha * classification_loss
            ...
            if val_loader:
                ...
                if val_loss < self.best_loss:
                    ...
                    self.early_stop_counter = 0
                    self.save_model('resnet_pretrained_optimized2.pth')
                else:
...
def main():
    ...
    trainer.save_model('resnet_pretrained_optimized2.pth')
